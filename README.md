...
this repository is for Indian Students who wants to apply to Ivy Leagues and have questions about how they can achieve their goal
<br>
<br>
...
3. General-purpose LLMs are confidently wrong here. Ask a base model about Indian-specific admissions questions and it will produce fluent, plausible answers containing invented deadlines, stale aid policies, and hallucinated statistics. In a domain where a wrong deadline costs an applicant an entire cycle, fluency without grounding is worse than no answer.
   <br>
   <br>
   The goal of this project is a model that is specifically competent on the India → Ivy League pathway: accurate on process and policy, honest about uncertainty, and free of the sales incentive that shapes most existing advice.
<br>
<br>
